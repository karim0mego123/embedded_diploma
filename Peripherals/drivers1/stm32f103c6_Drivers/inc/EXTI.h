...
typedef struct{
	...
	uint8_t IRQ_EN		;		// Enable or disable The IRQ (IRQ Mask in EXTI and NVIC Interrupt)
								//this parameter must be set based on @ref EXTI_IRQ_define

	void(*P_IRQ_CallBak)(void) ; // set the c function which will be called once IRQ Happen
...
#define EXTI_Trigger_RisingAnd_Falling 	2

// @ref EXTI_IRQ_define

#define EXTI_IRQ_Enable					1
#define EXTI_IRQ_Disble					0
